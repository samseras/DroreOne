...
<script>
    ...
    export default {
        ...
        methods: {
            treeShow(){
                console.log(this.getfacilityIndicator)
                if(this.getfacilityIndicator){
                    this.lightCheckout=this.getfacilityIndicator
                }
            },
            showBroadCard() {
                console.log(777)
            ...
            async getAllLight(){
                await api.indicator.getAllIndicator().then(res => {
                    ...
                    this.lightList.forEach(item => {
                        ...
                        item.id =  item.signboardBean.id
                        item.type = 'indicator'
                        item.icon = '../../../static/img/indicator_big.svg'
                        if (item.regionId) {
        ...
        computed: {
            ...mapGetters(['getfacilityIndicator'])
        }
    }
</script>
