<template>
	<div id="passenger-Flow">
		...
		<div id="passengerF-Content" >
			<div :style="{width:data[0].width,height:data[0].height,left:data[0].left,top:data[0].top}" class="children">
                <div class="top">
			...
			<div :style="{width:data[1].width,height:data[1].height,left:data[1].left,top:data[1].top}" class="children">
                <div class="top">
			...
			<div :style="{width:data[2].width,height:data[2].height,left:data[2].left,top:data[2].top}" class="children">
                <div class="top">
			...
			<div :style="{width:data[3].width,height:data[3].height,left:data[3].left,top:data[3].top}" class="children">
                <div class="top">
			...
			<div :style="{width:data[4].width,height:data[4].height,left:data[4].left,top:data[4].top}" class="children">
                <div class="top">
...
<style scoped>
	#passenger-Flow{width: 100%;height: 100%;background: #174984;display: flex;flex-direction: column;overflow-y:scroll;}
	#passengerF-Top{
		width: 92%;
		height:35px;
		margin: 15px auto;
    ...
    div.children:nth-child(3){border-right: none;}
    div.children:nth-child(4){border-right: none;}
