    ...
    <div class="security">
        <div class="security-reveal">
            ...
            <div class="top">
                <h5>安保人员</h5>
                <ul>
                    <li @click="showPersonCard" id='newagenda'><img src="../../../../static/img/newFile.png"/></li>
        ...
        <PersonCard v-if="isShowPersonCard" @closePersonCard="isShowPersonCard = false" class="personCard"></PersonCard>
...
<script>
    ...
    import PersonCard from './children/personCard'
