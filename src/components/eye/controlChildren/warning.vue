...
<style scoped>
  *{margin: 0;padding: 0;}
  ...
  .warn{width: 100%;height: 100%;display: flex;flex-direction: column;}
  .warn .top{width: 100%;height: 40px;line-height: 40px;display: flex;justify-content: space-between;background: #fafafa;}
  .warn .top h5{margin-left: 15px;}
  .warn .top ul{display: flex;}
  .warn .top ul li{margin: 0 10px;}
  #search{width: 88%;margin: 5px 6% 10px;text-indent: 10px;font-size: 10px;color: #646464;height: 20px;}
  .middle{width: 100%;flex:1;background: #fff;display: flex;flex-direction: column;}
  ...
  .last{width: 100%;height: 190px;}
  .last h5{line-height: 40px;margin-left: 15px;}
  .last h5+div{width: 100%;height: 143px;background: #fff;}
