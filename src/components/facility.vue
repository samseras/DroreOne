    ...
    <div class="facility">
        ...
        <div class="menu">
            ...
            <div class="right">
                ...
                <ul>
                    <li v-for="(item, index) in title" v-if="item.controlShow" :class="activeIndex === index? 'active':''" @click="goRouteModule(index)">
...
<script>
    ...
    export default {
        data () {
            return {
                title:[
                  {name:'ROAD',route:'/facility/road',img:'../../../static/img/roat.svg',desc:"路网",controlShow:true},
                  {name:'PARKING',route:'/facility/park',img:'../../../static/img/park.svg',desc:"停车场",controlShow:false},
                  {name:'TOILET',route:'/facility/toilet',img:'../../../static/img/toilet.svg',desc:"卫生间",controlShow:false},
                  {name:'BUSINESS',route:'/facility/shop',img:'../../../static/img/shop.svg',desc:"商铺",controlShow:false},
                  {name:'BUILDING',route:'/facility/build',img:'../../../static/img/build.svg',desc:"建筑",controlShow:false},
                  {name:'SCENICSPOT',route:'/facility/scenic',img:'../../../static/img/scenic.svg',desc:"景点",controlShow:false},
                  {name:'DUSTBIN',route:'/facility/trash',img:'../../../static/img/trash.svg',desc:"垃圾桶",controlShow:false},
                  {name:'PLANT',route:'/facility/plant',img:'../../../static/img/plant.svg',desc:"植物",controlShow:false},
                  {name:'SIGNBOARD',route:'/facility/indicator',img:'../../../static/img/indicator.svg',desc:"指示牌",controlShow:false}
                 ],
