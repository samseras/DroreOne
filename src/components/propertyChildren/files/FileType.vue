    ...
    export default {
        ...
        methods: {
                ...
                this.$confirm(message, '提示', {
                    ...
                    this.basicList = this.basicList.filter(item => {
                        if (item.id === id) {
                            ...
                            api.file.updataFileType(JSON.stringify(obj)).then(res => {
                    ...
                    this.$store.commit('SET_FILE_TYPE', this.basicList)
                }).catch(err => {
                    this.basicList  = this.basicList.filter(item => {
                        if (item.id === id) {
                            item.enable = !item.enable
            ...
            async getMenuType () {
                ...
                await api.file.getFileType().then(res => {
